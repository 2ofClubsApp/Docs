module.exports = {
  someSidebar: {
    "Getting Started": ['welcome', 'installation', 'configuration'],
    ...
    "User" : ['get_user'],
    "Club" : ['create_club', 'update_club', 'get_club', 'get_club_managers', 'add_manager', 'remove_manager', 'promote_new_club_owner', 'leave_club', 'swipe_club', 'unswipe_club', 'get_swiped_clubs'],
